...
})({"cBNmB":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "0c488058c8b8f878";
"use strict";
...
},{}],"9lsXg":[function(require,module,exports) {
// Import our navigation script
var _navigation = require("./global/navigation");
...
var _takaraCrane = require("./global/takaraCrane");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    (0, _takaraCrane.displayTakaraCrane)();
});

},{"./global/navigation":"4v1JF","./global/takaraCrane":"eabm6"}],"4v1JF":[function(require,module,exports) {
/**
 * @file navigation.js
...
parcelHelpers.export(exports, "initializeNavigation", ()=>initializeNavigation);
function initializeNavigation() {
    ...
    function setupMobileMenu() {
        const parentSections = document.querySelectorAll(".navbar-menu .parent-section");
                    ...
                    parentSections.forEach((otherSection)=>{
                        if (otherSection !== section) {
                            ...
                            if (otherSubmenu && otherSubmenu.classList.contains("submenu")) {
                                ...
                                otherSection.querySelector("svg")?.classList.remove("rotate-180");
                            }
                        }
                    });
                }
    ...
    requiredElements.mobileMenuBackdrop.addEventListener("click", toggleMobileMenu);
    document.addEventListener("keydown", (e)=>{
        if (e.key === "Escape") {
            hideSubmenu();
            if (!requiredElements.mobileMenu.classList.contains("hidden")) toggleMobileMenu();
...
},{}],"eabm6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayTakaraCrane", ()=>displayTakaraCrane);
const takaraCrane = `
 #                                                
   #                                              
    ##                               # #          
      ...
      # #                                         
`;
function displayTakaraCrane() {
    console.info("%c" + takaraCrane, "color: #B91C1C; font-family: monospace;", "We're hiring! https://www.linkedin.com/company/takara-ai/jobs/");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cBNmB","9lsXg"], "9lsXg", "parcelRequireedc5")
